...
CREATE TABLE `proyecto` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `ix_tipo_proyecto_id` (`tipo_proyecto_id`) USING BTREE,
  UNIQUE KEY `nombre_UNIQUE` (`nombre`),
  CONSTRAINT `fk_tipo_proyecto_id` FOREIGN KEY (`tipo_proyecto_id`) REFERENCES `tipo_proyecto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2018-07-24 18:50:59
